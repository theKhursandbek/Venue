  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 animate-fade-in">
      <div className="relative">
        <div className="absolute -inset-3 bg-primary-400/15 rounded-full blur-2xl animate-pulse-soft" />
        <div className="absolute -inset-1.5 bg-accent-400/10 rounded-full blur-xl animate-pulse-soft" style={{ animationDelay: "1s" }} />
