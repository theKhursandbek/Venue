...
export default function PageLoader() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 animate-fade-in">
      <div className="size-14 rounded-2xl bg-linear-to-br from-primary-500/20 to-accent-500/20 flex items-center justify-center mb-4 animate-levitate">
        <Spinner className="size-6! text-primary-400" />
      </div>
      <p className="text-[13px] text-surface-500 font-medium">{t("common.loading")}</p>
